Module Module1
    ...
    Sub Main(args As String())
        ...
        EUR = 1.1 'These three lines are exchange rates
        PLN = 4.8
        USD = 1.6
        ...
        If Currency = "EUR" Then 'If statement to determine currency input and to use the amount entered in a multiplication sum to convert to the three different currencies
